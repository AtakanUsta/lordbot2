...
module.exports.run = async (bot, message, args) => {
        ...
        let rol8 = message.guild.roles.find('name', "💚Aktif Üye💚");
            ...
            kanal.overwritePermissions(rol, {
                ...
                .setAuthor("Sohpet Kapatıldı !", `${message.author.avatarURL}`)
                ...
                .setTimestamp()
                .addBlankField()
                .addField("Sohpet Tekrar Açılanakadar Konuşulamaz!", "Yetkilinin Sohpeti Açması İçin Yazması Gereken : .sohpetaç")
                .addBlankField()
